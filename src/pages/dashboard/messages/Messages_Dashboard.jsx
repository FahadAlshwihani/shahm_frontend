          ...
          <table className="dashboard-messages-table">
            ...
            <tbody>
              {paginatedMessages.map((m) => (
                <tr key={m.id}>
                  <td className="dashboard-messages-table-phone">
                    <div className="dashboard-messages-phone-wrapper">
                      {m.phone}

                      {/* copy */}
                      <button
                        className="dashboard-messages-btn-copy"
                        onClick={() => {
                      ...
                      <a
                        ...
                        className="dashboard-messages-btn-whatsapp"
                      >
                        WhatsApp
                      </a>
                    </div>
